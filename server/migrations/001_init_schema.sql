-- 001_init_schema — base OptionTrap schema.
-- Applied once and tracked in schema_migrations. Do not edit after it has run
-- in any environment; add a new numbered migration for changes instead.
