...
const Admin: React.FC = () => {
  ...
  const handleStatusChange = async (id: string, status: FeedbackStatus) => {
    ...
    try {
      ...
      // If a status filter is active, the item may drop out of the list — reload.
      // Otherwise update in place for a snappier feel.
      if (statusFilter) {
        await load();
      } else {
  ...
  return (
    <div className="admin">
      <div className="page-header">
        <div>
          <h1 className="page-header__title">Feedback Inbox</h1>
          <p className="page-header__subtitle">Review and triage user-submitted feedback.</p>
        </div>
      </div>
